...
export default function RegisterVendorPage() {
  ...
  const stepTitles = ["Choose Account Type", "Create your vendor account", "Complete KYC Verification", "Application Submitted"];
  const stepSubs = [
        ...
        {step === 3 ? (
          <div className="text-center py-8">
            ...
            <p className="mt-3 text-muted-foreground max-w-md mx-auto">
              Thank you for applying to PakDropship as a <strong>Vendor / Supplier</strong>. Once your KYC is verified by our admin, your account will be activated.
            </p>
            ...
            {step === 1 && (
              <div className="space-y-5">
                <div className="p-3 bg-primary/5 border border-primary/20 text-sm font-semibold text-primary rounded-none">
                  Registering as: <span className="uppercase">Vendor / Supplier</span>
                  <Link href="/register" className="ml-2 text-xs underline text-muted-foreground">Change to Reseller</Link>
                </div>
                <div>
